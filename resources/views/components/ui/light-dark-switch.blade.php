<button
    ...
    "
    class="flex items-center justify-center hover:bg-gray-200 text-gray-500 hover:text-gray-600 dark:hover:bg-gray-800 dark:text-gray-300 dark:hover:text-gray-100 w-[38px] h-[38px] overflow-hidden rounded-full"
>
